...
5. **Nicht-Ziele in `docs/CONCEPT.md` 2.2 nicht anfangen, auch nicht "schon mal vorbereiten", solange sie dort nicht als umgesetzt stehen.** Multi-Provider, Mehrbenutzerbetrieb, Notifications, Cron-Scheduling, Suppression, License-Anzeige, Sustainability-/Dead-Project-Score, Audit-Log und Checksum-Verifikation der Scanner-Binaries sind inzwischen umgesetzt — daran normal weiterbauen. Weiterhin nicht anfangen: KI-Features, SBOM-Export, PostgreSQL, incoming Webhooks/Event-getriebene Scans, EPSS/CISA-KEV, echte Teams. Aktueller Stand: `docs/CONCEPT.md` 2.2.
